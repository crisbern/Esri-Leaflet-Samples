...
define(['dojo/_base/declare',
    ...
    'dojo/_base/array',
    'dojo/_base/lang','esri/request'
],
  function (declare, html, query, _WidgetsInTemplateMixin, BaseWidget, TimeExtent, TimeSlider, array, lang, esriRequest) {
      var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
          ...
          startup: function () {
              ...
              var requestHandle = esriRequest({
                  ...
                  timeSlider.on("time-extent-change", this.extentChanged);
                  timeSlider.startup();
          ...
          extentChanged: function (evt) {
              var startVal = evt.startTime.getFullYear();
              var endVal = evt.endTime.getFullYear();
              console.debug("<b> Current Time Extent:" + startVal + " TO " + endVal + "<\/b>");
              /*
